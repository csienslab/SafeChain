...
class Controller:
    ...
    def check(self, policy, custom=True, grouping=False, pruning=False, timeout=1800):
        ...
        filename, result, checking_time = policy.check(self, timeout)
...
if __name__ == '__main__':
    ...
    filename, result, grouping_time, pruning_time, parsing_time, checking_time = controller.check(policy, grouping=False, pruning=True)
